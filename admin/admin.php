...
$(document).ready(function() {
    ...
    <header class="cd-main-header">
		<a href="admin.php" class="cd-logo" style="text-align:left; background-color:black;" ><img src="../img_recoleta/LOGOS/Home_Ker_Recoleta_logo.png" width="90" alt="Logo"></a>
