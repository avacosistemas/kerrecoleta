<?php include("header.php");?>
        ...
        <div class="habitaciones_detalle">
	        ...
	        <div class="col-md-8 borde">
		        ...
		        <p>
			        Para disfrutar en familia y que todos tengan una estadía confortable y segura, contamos con cómodas habitaciones de
30 m2 que pueden acomodar hasta cuatro personas; se pueden armar con una cama Queen y dos camas Twin o también con una cama King y otra Queen. Se aceptan dos adultos y dos menores de 18 años de edad.
